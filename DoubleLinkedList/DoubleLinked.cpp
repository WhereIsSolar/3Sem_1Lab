...
void addHead(DLList &list, const std::string &val) {
...
void addTail(DLList &list, const std::string &val) {
...
bool addBefore(DLList &list, const std::string &target, const std::string &val) {
    DNode* cur = list.head;
...
bool addAfter(DLList &list, const std::string &target, const std::string &val) {
    DNode* cur = list.head;
    while (cur && cur->value != target) cur = cur->next;
    if (!cur) return false;
...
bool removeValue(DLList &list, const std::string &val) {
    DNode* cur = list.head;
...
bool removeBefore(DLList &list, const std::string &target) {
    DNode* cur = list.head;
    while (cur && cur->value != target) cur = cur->next;
...
bool removeAfter(DLList &list, const std::string &target) {
    DNode* cur = list.head;
    while (cur && cur->value != target) cur = cur->next;
...
DNode* findValue(DLList &list, const std::string &val) {
    DNode* cur = list.head;
    while (cur && cur->value != val) cur = cur->next;
    return cur;
}
...
void readFromFile(DLList &list, const std::string &filename) {
...
void writeToFile(DLList &list, const std::string &filename) {
